...
public class ConfirmScreen extends GuiWindow {
    ...
    public ConfirmScreen(Player holder, Consumer<InventoryClickEvent> todo) {
        ...
        super.addComponent(new Button(20, new ItemStackBuilder(Material.WOOL, 1).dyeColor(DyeColor.GREEN).name("YES").build(), todo::accept));
        super.addComponent(new Button(24, new ItemStackBuilder(Material.WOOL, 1).dyeColor(DyeColor.RED).name("NO").build(), (event) -> {
